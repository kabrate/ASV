import argparse
import torch
# --config C:/Users/jing/adsv_voting/config/voting.yaml --trial_path C:/Users/jing/adsv_voting/data/vox1.txt --checkpoint_path C:/Users/jing/adsv_voting/tools/exp/aam/epoch=31_cosine_eer=4.51.ckpt
# --config C:/Users/jing/adsv_voting/config/voting.yaml --trial_path C:/Users/jing/adsv_voting/local/data/adv_data/adv_trials.txt --checkpoint_path C:/Users/jing/adsv_voting/tools/exp/aam/epoch=31_cosine_eer=4.51.ckpt
from torch_speaker.torch_speaker.utils import cfg, load_config
from torch_speaker.torch_speaker.module import Task
from pytorch_lightning import Trainer
from pytorch_lightning.callbacks import ModelCheckpoint, LearningRateMonitor, Callback
# key if finding of trails_txt
if __name__ == "__main__":
    ...
    load_config(cfg, args.config)   #cfg save  parameters
    cfg.trainer.gpus = 1
